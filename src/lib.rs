...
#[derive(Debug)]
pub struct LLMCoreProcessor {
    verbose: bool,
    processed_count: usize,
}

impl LLMCoreProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting LLMCore processing");
    
    let mut processor = LLMCoreProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = LLMCoreProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = LLMCoreProcessor::new(false);
